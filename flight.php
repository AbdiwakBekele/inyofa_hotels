    ...
    <div class="row">
        <div class="col">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" href="flight.php">Round Trip</a>
                </li>
                <li class="nav-item">
            ...
            <div class="row m-2">
                ...
                <div class="col-md mt-2">
                    <p class="h6 text-dark"> <strong>Return Date</strong> </p>
                    <input type="date" name="return_date" class="form-control form-control-lg border border-dark "
