    ...
    <body>
        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content" class="p-4 p-md-5">
                ...
                <a class="btn btn-primary text-white m-3 " style="text-decoration: none" href="add_user_admin.php"> Add
                    New Hotel Admin </a>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr class="h5">
                                            <th colspan="9" class="bg-dark text-white">
                                                <center>Hotel Admins Table</center>
                                            </th>
                                        </tr>
                                    </thead>
                                    <thead>
                                        <tr class="h6 bg-primary text-white">
                                            ...
                                            <th class="text-center" scope="col">Admin Full Name</th>
                                            <th class="text-center" scope="col">Email</th>
                                            <th class="text-center" scope="col">Assigned Hotel</th>
                                    ...
                                    <tbody>
                                        <?php
                                                ...
                                                $index = 1;
                                                while ($result = mysqli_fetch_assoc($user_hotels)) {
                                                    $hotel_id  = $result['hotel_id'];
                                                    $assigned_hotel_name =  $result['hotel_name'];
                                                    
                                                    $sql_admin = "SELECT * FROM hotel_admin WHERE hotel_id = '$hotel_id'";
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result_admin)) { 
                                                        ...
                                                        printf(
                                                            ...
                                                            $index++,
                                                            htmlspecialchars($row['hotel_admin_name']),
                                                            htmlspecialchars($row['hotel_admin_email']),
                                                            htmlspecialchars($assigned_hotel_name),
                                                        );
                                            ?>
                                        <td class="text-center h3">

                                            <a
                                                href="hotel_admin_view_api.php?hotel_admin_id=<?php echo $row['hotel_admin_id'] ?>"><i
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a style="text-decoration: none;"
                                                                href="hotel_admin_delete.php?hotel_admin_id=<?php echo $row['hotel_admin_id'] ?>"
