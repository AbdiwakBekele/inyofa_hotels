        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content" class="p-4 p-md-5">
                ...
                <div class="col-sm-12 col-md-8 offset-md-2">
                    ...
                    <!------ New Rental Form ------->
                    <form class="was-validated bg-light border shadow p-3" action="edit_user_rental.php" method="POST"
                        ...
                        if (isset($_POST['Submit'])) {
                            ...
                            if (in_array($imageFileType, $extensions_arr) && in_array($imageFileType2, $extensions_arr2) && in_array($imageFileType3, $extensions_arr3)) {
                                ...
                                $query = "UPDATE rental set rental_type = '$rental_type', rental_country='$rental_country', rental_subcity='$rental_subcity', rental_area='$rental_area', rental_bed_no='$rental_bed_no', rental_kitchen_no = '$rental_kitchen_no', rental_bath_no='$rental_bath_no', rental_image1='$temp_rental_img1', rental_image2='$temp_rental_img2', rental_image3='$temp_rental_img3', rental_price='$rental_price', rental_contact='$rental_contact', rental_detail='$rental_detail' WHERE rental_id = '$rental_id' ";
                            ...
                            <div class="form-group col-md">
                                ...
                                <select class="form-control" name="rental_type" id="rental_type" required>
                                    ...
                                    <option value="Apartment"
                                        <?php $selected = ($rental_type == 'Apartment') ? 'Selected' : ""; echo $selected ?>>
                                        Apartment </option>
                                    <option value="Condominium"
                                        <?php $selected = ($rental_type == 'Condominium') ? 'Selected' : ""; echo $selected ?>>
                                        Condominium </option>
                                    <option value="Double"
                                        <?php $selected = ($rental_type == 'Double') ? 'Selected' : ""; echo $selected ?>>
                                        Double </option>
                                    <option value="Studio"
                                        <?php $selected = ($rental_type == 'Studio') ? 'Selected' : ""; echo $selected ?>>
                                        Studio </option>
                                </select>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="form-group col-md">
                                ...
                                <input type="text" class="form-control" name="rental_city" id="rental_city"
                                    placeholder="Rental City" value="<?php echo $rental_city ?>" required>
                                <div class="valid-feedback">good</div>
                                <div class="invalid-feedback">fill-out</div>
                            </div>
                            ...
                            <div class="form-group col-md">
                                ...
                                <input type="text" class="form-control" name="rental_subcity" id="rental_subcity"
                                    placeholder="Rental Subcity" value="<?php echo $rental_subcity ?>" required>
                                <div class="valid-feedback">good</div>
                                <div class="invalid-feedback">fill-out</div>
                            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="form-group mt-2 col-md-6 col-sm-12">
                                ...
                                <input type="number" class="form-control" name="rental_price" id="rental_price"
                                    placeholder="Enter Rental Price" value="<?php echo $rental_price ?>" required>
                                <div class="valid-feedback">good</div>
                                <div class="invalid-feedback">fill-out</div>
                            </div>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="phone" class="form-control" name="rental_contact_address"
                                    ...
                                    value="<?php echo $rental_contact ?>" required>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="form-group mt-2 col-md-6 col-sm-12">
                                ...
                                <input type="number" class="form-control" name="rental_area" id="rental_area"
                                    placeholder="Enter Rental Square area" value="<?php echo $rental_area ?>" required>
                                <div class="valid-feedback">good</div>
                                <div class="invalid-feedback">fill-out</div>
                            </div>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="number" class="form-control" name="rental_bed_no" for="rental_bed_no"
                                    placeholder="No of bed rooms" value="<?php echo $rental_bed_no ?>" required>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="form-group mt-2 col-md-6 col-sm-12">
                                ...
                                <input type="number" class="form-control" name="rental_kitchen_no"
                                    ...
                                    value="<?php echo $rental_kitchen_no ?>" required>
                                <div class="valid-feedback">good</div>
                                <div class="invalid-feedback">fill-out</div>
                            </div>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="phone" class="form-control" name="rental_bath_no" for="rental_bath_no"
                                    placeholder="No of Bath room" value="<?php echo $rental_bath_no ?>" required>
                        ...
                        <div class="row mt-3">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" rows="10" name="rental_detail" id="rental_detail"
                                    placeholder="Enter Rental Detail" required> <?php echo $rental_detail ?></textarea>
