    ...
    <body>
        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content" class="p-4 p-md-5">
                ...
                <form class="was-validated bg-light border shadow p-3" action="hotel_info.php" method="POST"
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="form-group col-md">
                            ...
                            <input type="url" class="form-control" name="hotel_map" for="hotel_map"
                                placeholder="Hotel Map" value="<?php echo $hotel_map; ?>" required>
                    ...
                    <div class="px-5 border border-black shadow">
                        ...
                        <div class="row mt-3">
                            ...
                            <textarea class="form-control mx-2" rows="5" id="arrival_and_leaving"
                                name="arrival_and_leaving" required>  <?php echo $arrival_and_leaving; ?> </textarea>
                            <div class="valid-feedback">good</div>
                            <div class="invalid-feedback">fill-out</div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <textarea class="form-control mx-2" rows="5" id="restriction_related"
                                name="restriction_related" required>  <?php echo $restriction_related; ?> </textarea>
                            <div class="valid-feedback">good</div>
                            <div class="invalid-feedback">fill-out</div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <textarea class="form-control mx-2" rows="5" id="required_documents"
                                name="required_documents" required>  <?php echo $required_documents; ?>  </textarea>
                            <div class="valid-feedback">good</div>
                            <div class="invalid-feedback">fill-out</div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <textarea class="form-control mx-2" rows="5" id="transfer_and_others"
                                name="transfer_and_others" required>  <?php echo $transfer_and_others; ?> </textarea>
                            <div class="valid-feedback">good</div>
                            <div class="invalid-feedback">fill-out</div>
                        </div>
                    </div>
