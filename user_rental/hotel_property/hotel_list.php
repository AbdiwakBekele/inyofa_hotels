                            ...
                            <div class="col-md">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <?php
                                        $q = "SELECT * FROM hotels WHERE user_id = '$user_id'";
                                        $q_result = mysqli_query($con, $q);
                                        while ($row = mysqli_fetch_assoc($q_result)) {
                                                $isApproved = $row['isApproved'] == '1' ? 'YES' : 'NO';
                                            printf(
                                        ...
                                        ?>
                                            <td class="text-center h3">
                                                <a href="view_user_hotel.php?hotel_id=<?php echo $row['hotel_id'] ?>"><i
                                                        style="font-size: 20px"
                                                        class="fas fa-address-card px-2 text-primary"></i></a>

                                                <a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#myModal<?php echo $row['hotel_id'] ?>">
                                                    <i class="fas fa-trash-alt px-2 text-danger"
                                                        style="font-size: 20px;"></i>
                                                </a>

                                                <!-- Delete Modal -->
                                                <div class="modal" id="myModal<?php echo $row['hotel_id'] ?>">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a style="text-decoration: none;"
                                                                    href="delete_user_hotel.php?hotel_id=<?php echo $row['hotel_id'] ?>"
