                        ...
                        <div class="row">
                            ...
                            <div class="col-md mt-2">
                                <input type="date" id="checkin"
                                    class="form-control form-control-lg border border-dark icon_date"
                                    oninput="date_cal()" min="1899-01-01" max="2030-13-13">
                                </input>
                        ...
                        <div class="shop-close-content">
                            ...
                            <div class="m-4">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input border-primary " type="checkbox" id="bole"
                                ...
                                <div class="m-4">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input border-primary " type="radio"
                                            id="greater_than_300" name="price_per_night" value="301"
                            ...
                            <div class="m-4">
                                ...
                                <form action="listing.php" method="post">
                                    <input type="hidden" name="location" value="<?php echo $location; ?>">
                                    <button class="btn btn-white border-secondary m-1 w-25" value="1"
                                        name="class_submit" type="submit">1 Star</button>
                                    <button class="btn btn-white border-secondary m-1 w-25" value="2"
                                        name="class_submit" type="submit">2 Star</button>
                                    <button class="btn btn-white border-secondary m-1 w-25" value="3"
                                        name="class_submit" type="submit">3 Star</button>
                                    <button class="btn btn-white border-secondary m-1 w-25" value="4"
                                        name="class_submit" type="submit">4 Star</button>
                                    <button class="btn btn-white border-secondary m-1 w-25" value="5"
                                        name="class_submit" type="submit">5 Star</button>
                                </form>
                            </div>
                            ...
                            <div class="m-4">
                                ...
                                <form action="listing.php" method="post">
                                    ...
                                    <!-- Lideta -->
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="lideta" name="area"
                                            value="lideta" onchange="this.form.submit()"
                                    ...
                                    <div class="collapse" id="area_collapse">
                                        ...
                                        <!-- Yeka -->
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" id="yeka" name="area"
                                                value="yeka" onchange="this.form.submit()"
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label h6 text-black "
                                                for="bishoftu">Bishoftu</label>
                                        </div>
                                        <!-- Lege T'afo -->
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" id="lege" name="area"
                                                value="lege" onchange="this.form.submit()"
                                ...
                                <form action="listing.php" method="post">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input border-primary " type="checkbox"
                                            id="free_shuttle" name="free_shuttle" value="free_shuttle"
                                    ...
                                    <!-- Spa -->
                                    <div class="form-check">
                                        <input class="form-check-input border-primary " type="checkbox" id="spa"
                                            name="spa" value="spa"
                                    ...
                                    <div class="collapse" id="amenities_collapse">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input border-primary " type="checkbox"
                                                id="restaurant" name="restaurant" value="restaurant"
                    ...
                    <div class="shop-grid-contents">
                        ...
                        ?>
                            ...
                            <div class="row my-2 bg-white">
                                ...
                                <div class="col-4">
                                    <!--Image Carousel -->
                                    <div id="<?php echo '_' . $hotel_id; ?>" class="carousel slide"
                                    ...
                                    <a href="hotel_detail.php?hotel_id=<?php echo $hotel_id ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4" style="display: inline">
                                                <i class="<?php echo $icon ?> mx-1"
                                                    style="font-size: 17px; color: black" aria-hidden="true"></i>
                                        ...
                                        <div class="row">
                                            <div class="col-6 mt-4">
                                                ...
                                                <p style="font-size: 15px; color: black">
                                                    <strong><?php echo $hotel_rating ?> <i
