    ...
    <body>
        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content" class="p-4 p-md-5">
                ...
                <form class="was-validated bg-light border shadow p-3" action="ha_room_edit.php" method="POST"
                    ...
                    if (isset($_POST['Submit'])) {
                        ...
                        $reserve_status = $_POST['room_status'];
                        $room_id = $_POST['room_id'];

                        $query = "UPDATE room SET room_no='$room_no', room_floor='$room_floor', reserve_status='$reserve_status' WHERE room_id='$room_id'";

                        if (mysqli_query($con, $query)) {
                            $msg = "You have Successfully Updated room data";
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            while ($r = mysqli_fetch_assoc($q_room_result)) {
                                ...
                                if($r['room_type_id'] == $room_type_id ){
                                    ...
                                    echo " selected>{$r['room_type_name']}</option>";
                                }else{
                                    echo "<option name='room_type' value = '{$r['room_type_id']}'";
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <input type="number" class="form-control" name="room_no" for="room_no"
                                placeholder="Room Number" value="<?php echo $room_no?>" required>
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <input type="number" class="form-control" name="room_floor" for="room_floor"
                                placeholder="Room Floor" value="<?php echo $room_floor?>" required>
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            <label for="room_status" class="form-label">
                                <h6><b><i class="fas fa-users mx-2"></i>Room Status</b></h6>
                            </label>

                            <select class="form-control" name="room_status" id="room_status">
                                <?php  
                                if($room_status == "YES"){
                                    echo '<option name="room_status" value="YES" selected>YES</option>';
                                    echo '<option name="room_status" value="NO">NO</option>';
                                }else{
                                    echo '<option name="room_status" value="YES">YES</option>';
                                    echo '<option name="room_status" value="NO" selected>NO</option>';
                                }
                    ...
                    <div class="row">
                        <div class="col-md mt-3 mb-3">
                            ...
                            <button type="submit" name="Submit" class="btn btn-primary btn-large col-md-6 rounded"
                                value="Submit"> Update Room Detail</button>
                        </div>
                    </div>
