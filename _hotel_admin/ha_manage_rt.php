                        ...
                        <div class="col-md-12">
                            <a href="#" class="col-md-3" style="text-decoration: none;">
                                <div class="card bg-warning text-dark">
                                    <div class="card-body">
                                        <h4><i class="fas fa-laptop-house"></i> Room Types</h4>
                                        <hr>
                                        <h5>
                                            <b><?php echo $room_type_count; ?></b>
                                        </h5>
                                    </div>
                                </div>
                            </a>
                ...
                <section class="mt-5 border bg-light">
                    <div class="container">
                        <div class="row g-4">
                            ...
                            <div class="col-md">
                                <a class="btn btn-outline-success text-dark m-4" href="ha_add_new_rt.php" role="button"
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <thead>
                                        <tr class="h6 bg-primary text-white">
                                            ...
                                            <th class="text-center" scope="col">Max Guest</th>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($q_result)) {
                                            ...
                                            printf(
                                                ...
                                                htmlspecialchars($row['room_type_max_guest']),
                                                htmlspecialchars($row['room_type_price']),
                                                htmlspecialchars($row['room_type_description']),
                                            );
                                        ?>
                                            <td class="text-center h3">
                                                <a href="ha_room_type_view.php?room_type_id=<?php echo $row['room_type_id'] ?>"><i
                                                        class="fas fa-address-card px-2 text-primary" style="font-size: 17px;"></i></a>
                                                
                                                <a href="ha_room_type_delete.php?room_type_id=<?php echo $row['room_type_id'] ?>"><i
                                                        class="fas fa-trash-alt px-2 text-danger" style="font-size: 17px;"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        }
