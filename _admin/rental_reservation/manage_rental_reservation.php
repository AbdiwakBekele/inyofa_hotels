...
// Rental Query
$q_rental = "SELECT * FROM rental_reservation";
            ...
            <nav id="sidebar">
                <div class="p-4 pt-5">
                    ...
                    <ul class="list-unstyled components mb-5">
                        ...
                        <li><a href="manage_rental_reservation.php" class="text-warning"><i
                                    ...
                                    <div class="card bg-light col-md mt-1" style="border-style: none;">
                                        <div class="card-body">
                                            <h4 class="card-title"><i class="fas fa-tachometer-alt"></i> <strong>Manage
                                                    Rentals Reservations </strong></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <a href="#" class="col-md-3" style="text-decoration: none;">
                                <div class="card bg-warning text-dark">
                                    <div class="card-body">
                                        <h4><i class="fas fa-house"></i> Available Rentals Properties</h4>
                                        <hr>
                                        <h5>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md">
                                <a class="btn btn-outline-success text-dark m-4" href="a_add_rental.php" role="button"
                                    style="text-decoration: none;"><i class="fas fa-plus"></i> Add Reservations</a>
                            </div>
                            ...
                            <div class="col-md">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr class="h5">
                                            <th colspan="9" class="bg-dark text-white">
                                                <center>Reserved Rentals Tables</center>
                                            </th>
                                        </tr>
                                    </thead>
                                    <thead>
                                        <tr class="h6 bg-primary text-white">
                                            ...
                                            <th class="text-center" scope="col">Rental Type</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <?php
                                        $q = "SELECT * FROM rental_reservation";
                                        $q_result = mysqli_query($con, $q);
                                            $index = 0;
                                        while ($row = mysqli_fetch_assoc($q_result)) {
                                                $rental_id = $row['rental_id'];
                                                $q_rental = "SELECT * FROM rental WHERE rental_id = '$rental_id'";
                                                $q_rental_result = mysqli_query($con, $q_rental);
                                                $rental_type = mysqli_fetch_assoc($q_rental_result)['rental_type'];

                                            printf(
                                                "<tr> <td>%d</td> <td>%s</td> <td>%s</td> <td>%s</td> <td>%s</td>",
                                                ++$index,
                                                htmlspecialchars($row['first_name']. ' '.$row['last_name']),
                                                htmlspecialchars($rental_type),
                                        ...
                                        ?>
                                            <td class="text-center h3">
                                                <a
                                                    href="rental_view_api.php?rental_id=<?php echo $row['rental_reservation_id'] ?>"><i
                                                        style="font-size: 20px"
                                                        class="fas fa-address-card px-2"></i></a>
                                                <a
                                                    href="rental_delete_api.php?rental_id=<?php echo $row['rental_reservation_id'] ?>"><i
                                                        style="font-size: 20px"
