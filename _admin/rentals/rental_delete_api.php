...
<html lang="en">
    ...
    <body>
        ...
        if (isset($_REQUEST['rental_id'])) {
            ...
            if($records){
            $del_res = "DELETE FROM reservation WHERE rental_id = '$rental_id'";
    ...
    ?>
        ...
        <a href="a_manage_rentals.php" style="text-decoration: none" class="btn btn-primary text-white mx-5 w-25"> Go
            Back </a>
