                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md">
                                <a class="btn btn-outline-success text-dark m-4" href="a_add_rental.php" role="button"
                                    style="text-decoration: none;"><i class="fas fa-plus"></i> Add New Rental</a>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <td class="text-center h3">
                                                <a href="rental_view_api.php?rental_id=<?php echo $row['rental_id'] ?>"><i
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a style="text-decoration: none;"
                                                                    href="rental_delete_api.php?rental_id=<?php echo $row['rental_id'] ?>"
