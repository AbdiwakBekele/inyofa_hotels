        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content" class="p-4 p-md-5">
                ...
                <div class="col-sm-12 col-md-8 offset-md-2">
                    ...
                    <form class="was-validated bg-light border shadow p-3" action="a_add_rental.php" method="POST"
                    ...
                    if (isset($_POST['Submit'])) {
                        ...
                        $rental_detail =  $_POST['rental_detail'];
                         ...
                         if (in_array($imageFileType, $extensions_arr) && in_array($imageFileType2, $extensions_arr2) && in_array($imageFileType3, $extensions_arr3)) {
                             ...
                             $query = "INSERT INTO rental (rental_type, rental_country, rental_city, rental_subcity, rental_price, rental_contact, rental_area, rental_bed_no, rental_kitchen_no, rental_bath_no, rental_detail, rental_image1, rental_image2, rental_image3)
                                                    VALUES ('$rental_type', '$rental_country', '$rental_city', '$rental_subcity', '$rental_price', '$rental_contact_address', '$rental_area',  '$rental_bed_no', '$rental_kitchen_no', '$rental_bath_no', '$rental_detail',  '$temp_rental_img1',  '$temp_rental_img2',  '$temp_rental_img3' )";
