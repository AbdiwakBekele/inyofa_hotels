        ...
        <div class="wrapper d-flex align-items-stretch">
            ...
            <div id="content" class="p-4 p-md-5">
                ...
                <div class="col-sm-12 col-md-8 offset-md-2">
                    ...
                    <form class="was-validated bg-light border shadow p-3" action="rental_edit_api.php" method="POST"
                    ...
                    if (isset($_POST['Submit'])) {
                        ...
                        //Check extension
                            if (in_array($imageFileType, $extensions_arr) && in_array($imageFileType2, $extensions_arr2) && in_array($imageFileType3, $extensions_arr3)) {
                                ...
                                $query = "UPDATE rental SET rental_type = '$rental_type', rental_country = '$rental_country', rental_city = '$rental_city', 
                                                     rental_subcity = '$rental_subcity', 
                                                     rental_area = '$rental_area',
                                                     rental_bed_no = '$rental_bed_no', 
                                                     rental_kitchen_no = '$rental_kitchen_no',
                                                     rental_bath_no = '$rental_bath_no',
                                                     rental_price = '$rental_price',
                                                     rental_contact = '$rental_contact',
                                                     rental_detail = '$rental_detail',
                                                     rental_image1 = '$temp_rental_img1',
                                                     rental_image1 = '$temp_rental_img2',
                                                     rental_image1 = '$temp_rental_img3'
                                                     WHERE rental_id = '$rental_id' ";

                                $query_result = mysqli_query($con, $query);

                                if (mysqli_query($con, $query)) {
                                    $msg = "<div class='alert alert-success' >You have Successfully Updated a rental information! </div> ";
                                    echo $msg;
                                } else {
                                    $msg = "Error Updating rental Information";
                                    echo $msg;
                    ...
                    /////////  Request for Editing Rental Details  /////////////
                    if (isset($_REQUEST['rental_id'])) {
                        ...
                        while ($r = mysqli_fetch_assoc($q_result)) {
                            $array['rental_id'] = $r['rental_id'];
                            $array['rental_type'] = $r['rental_type'];
                            $array['rental_country'] = $r['rental_country'];
                            $array['rental_city'] = $r['rental_city'];
                            $array['rental_subcity'] = $r['rental_subcity'];
                            $array['rental_area'] = $r['rental_area'];
                            $array['rental_bed_no'] = $r['rental_bed_no'];
                            $array['rental_kitchen_no'] = $r['rental_kitchen_no'];
                            $array['rental_bath_no'] = $r['rental_bath_no'];
                            $array['rental_image1'] = $r['rental_image1'];
                            $array['rental_image2'] = $r['rental_image2'];
                            $array['rental_image3'] = $r['rental_image3'];
                            $array['rental_price'] = $r['rental_price'];
                            $array['rental_contact'] = $r['rental_contact'];
                            $array['rental_detail'] = $r['rental_detail'];
                        }
                    ...
                    ?>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="form-group col-md">
                                ...
                                <select class="form-control" name="rental_type" id="rental_type" required>
                                    ...
                                    <option value="Apartment" <?php $selected = ($array['rental_type'] == "Apartment") ? "selected" : "";
                                    echo $selected; ?>> Apartment </option>
                                    <option value="Condominium" <?php $selected = ($array['rental_type'] == "Condominium") ? "selected" : "";
                                    echo $selected; ?>> Condominium </option>
                                    <option value="Double" <?php $selected = ($array['rental_type'] == "Double") ? "selected" : "";
                                    echo $selected; ?>> Double </option>
                                    <option value="Studio" <?php $selected = ($array['rental_type'] == "Studio") ? "selected" : "";
                                    echo $selected; ?>> Studio </option>
                                </select>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="form-group col-md">
                                ...
                                <input type="text" class="form-control" name="rental_city" id="rental_city"
                                    placeholder="Rental City" value="<?php echo $array['rental_city']; ?>" required>
                                <div class="valid-feedback">good</div>
                                <div class="invalid-feedback">fill-out</div>
                            </div>
                            ...
                            <div class="form-group col-md">
                                ...
                                <input type="text" class="form-control" name="rental_subcity" id="rental_subcity"
                                    placeholder="Rental Subcity" value=" <?php echo $array['rental_subcity']; ?>"
                                    required>
                                <div class="valid-feedback">good</div>
                                <div class="invalid-feedback">fill-out</div>
                            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="form-group mt-2 col-md-6 col-sm-12">
                                ...
                                <input type="number" class="form-control" name="rental_price" id="rental_price"
                                    placeholder="Enter Rental Price" value="<?php echo $array['rental_price']; ?>"
                                    required>
                                <div class="valid-feedback">good</div>
                                <div class="invalid-feedback">fill-out</div>
                            </div>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="phone" class="form-control" name="rental_contact"
                                    for="rental_contact_address" placeholder="Rental Contact Address"
                                    value="<?php echo $array['rental_contact']; ?>" required>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="form-group mt-2 col-md-6 col-sm-12">
                                ...
                                <input type="number" class="form-control" name="rental_area" id="rental_area"
                                    placeholder="Enter Rental Square area" value="<?php echo $array['rental_area']; ?>"
                                    required>
                                <div class="valid-feedback">good</div>
                                <div class="invalid-feedback">fill-out</div>
                            </div>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="phone" class="form-control" name="rental_bed_no" for="rental_bed_no"
                                    placeholder="No of bed rooms" value="<?php echo $array['rental_bed_no']; ?>"
                                    required>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="form-group mt-2 col-md-6 col-sm-12">
                                ...
                                <input type="number" class="form-control" name="rental_kitchen_no"
                                    id="rental_kitchen_no" placeholder="Enter Rental Square area"
                                    value="<?php echo $array['rental_kitchen_no']; ?>" required>
                                <div class="valid-feedback">good</div>
                                <div class="invalid-feedback">fill-out</div>
                            </div>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="phone" class="form-control" name="rental_bath_no" for="rental_bath_no"
                                    placeholder="No of Bath room" value="<?php echo $array['rental_bath_no']; ?>"
                                    required>
                        ...
                        <div class="row mt-3">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" rows="10" name="rental_detail" id="rental_detail"
                                    placeholder="Enter Rental Detail"
                                    required> <?php echo $array['rental_detail']; ?> </textarea>
                        ...
                        <div class="row">
                            <div class="col-md mt-3 mb-3">
                                <Input type="hidden" name="rental_id" value="<?php echo $array['rental_id']; ?>">
                                <button type="submit" name="Submit" class="btn btn-primary btn-large col-md-12"
                                    value="Submit">Edit Rental Data</button>
                            </div>
                        </div>
