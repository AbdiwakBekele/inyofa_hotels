...
<?php
    ...
    if (isset($_POST['Submit'])) {
        ...
        $table_query = "SELECT * FROM user WHERE user_email = '$email' AND user_password = '$password'";
        ...
        if ($count == 1) {
            ...
            //$logged = $email;
            setcookie("user_logged", date("F jS - g:i a"), $last);
            header('location:user_rental/user_dashboard.php');
        } else {
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <form class="was-validated border p-4 mb-4 bg-light border shadow the_logo_form" action="user_login.php"
                    method="post" name="form" onsubmit="return validated()">




                    <div class="alert alert-primary"> Start by signing in </div>
                    ...
                    <div class="row">
                        <div class="col-md">
                            <p class="mt-3 text-center text-secondary"><strong>No Account? <a
                                        href="user_signup.php">Sign up
                                        Here</a></strong></p>
                        </div>
                    </div>
