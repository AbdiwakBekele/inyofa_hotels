        ...
        <div id="demo" class=" carousel slide " data-bs-ride="carousel">
            ...
            <div class="carousel-inner" style="height: 300px;">
                <div class="carousel-item active">
                    <img src="hotels_image/<?php echo $hotel_img1; ?>" alt="<?php echo $hotel_name; ?>" class="d-block"
                        style="width:100%; height: 100%; object-fit: cover;">
                </div>
                <div class="carousel-item">
                    <img src="hotels_image/<?php echo $hotel_img2; ?>" alt="<?php echo $hotel_name; ?>" class="d-block"
                        style="width:100%;">
                </div>
                <div class=" carousel-item">
                    <img src="hotels_image/<?php echo $hotel_img3; ?>" alt="<?php echo $hotel_name; ?>" class="d-block"
                        style="width:100%;">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mt-2">
                ...
                <div class="bg-white p-2">
                    ...
                    <!-- Collapse Amenities -->
                    <a href="<?php echo "#collapse_".$room_type_id;?>" data-bs-toggle="collapse" class="text-primary">
