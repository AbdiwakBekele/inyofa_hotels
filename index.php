            ...
            <div class="row">
                <div class="col-md mt-2">
                    <input type="text" name="location"
                        class="form-control form-control-lg border border-dark icon_location" placeholder="Going to..."
                        required>
                </div>

                <!-- Checkin Date -->
                <div class="col-md mt-2">
                    <input type="date" id="checkin" class="form-control form-control-lg border border-dark icon_date"
                ...
                <!-- Checkout Date -->
                <div class="col-md mt-2">
                    <input type="date" id="checkout" class="form-control form-control-lg border border-dark icon_date"
