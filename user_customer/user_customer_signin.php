                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <a class="text-primary text-center m-2" href="user_customer_signin.php"
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <form class="was-validated bg-light border shadow p-3" action="user_customer_signin.php" method="POST"
                    ...
                    if (isset($_POST['Submit'])) {
                        ...
                        if ($user_password == $confirm_user_password) {
                            $query = "INSERT INTO user_customer (user_fullname, user_email, user_birth_date, user_phone, user_address, user_password)
                                                    VALUES ('$user_fullname', '$user_email', '$user_birth_date', '$user_phone', '$user_address', '$user_password')";

                            if (mysqli_query($con, $query)) {
                                $msg = "<div class='alert alert-success'> Successfully Registered! </div> <a class='btn btn-primary text-white' href='user_customer_login.php'>Login</a> ";
                                echo $msg;
                            } else {
