    ...
    <body style="background-color: #f2f2f2;">
        ...
        <?php 
            ...
            if (isset($_REQUEST['rental_id'])) {
                ...
                $q_result = mysqli_query($con, $q_rental);
        ...
        <div class="container">
            ...
            <h2 class="m-3"> <strong> Rental Property | <?php echo $rental_type?> </strong> </h2>
            ...
            <form action="confirm_rental.php" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="bg-white p-3 mt-2">
                            ...
                            <!-- Checkin checkout -->
                            <div class="row">
                                <p class="text-muted"> <strong>Confirm your stay</strong> <span
                            ...
                            <button class="btn btn-primary m-3" type="submit" name="Submit">Book without
                                Payment</button>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="bg-white p-3 mt-2">
                            <i class="fa fa-user mx-3" style="font-size: 25px" aria-hidden="true"></i>
                            <h4 style="display: inline;"> <strong> Step 2: Reservation Card Detail(Optional) </strong>
                            </h4>
                            <hr>
                            <!-- Payment -->
                            <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <input type="number" class="form-control" id="expiryYear"
                                                    placeholder="YY" name="expiryYear">
                                            </div>
                                        </div>
