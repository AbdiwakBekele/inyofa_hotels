            ...
            <nav class="navbar navbar-expand-md navbar-dark" style="background-color: #336699;">
                <div class="container-fluid">
                    ...
                    <div class="navbar-toggler text-center mx-2 my-2" style="border: none;" type="button">
                        ...
                        <a href="rental.php" class="text-white mx-2 p-2 border border-white rounded-pill"
                            style="font-size: 15px; text-decoration: none; "><span
                                ...
                                <div class="m-4">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input border-primary " type="radio"
                                            id="greater_than_4000" name="price_per_month" value="4001"
                                            onchange="this.form.submit()"
                                        ...
                                        <div id="<?php echo '_' . $rental_id; ?>" class="carousel slide"
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img src="<?php echo "rental_image/".$rental_image1 ?>"
                                                        alt="rent_image" style="object-fit: cover;"
                                                        class="d-block w-100" height="300px">

                                                </div>
                                                <div class="carousel-item ">
                                                    <img src="<?php echo "rental_image/".$rental_image2 ?>"
                                                        alt="rent_image" style="object-fit: cover;"
                                                        class="d-block w-100" height="300px">
                                                </div>
                                                <div class="carousel-item ">
                                                    <img src="<?php echo "rental_image/".$rental_image3 ?>"
                                                        alt="rent_image" style="object-fit: cover;"
                                                        class="d-block w-100" height="300px">
                                                </div>
                                            </div>
